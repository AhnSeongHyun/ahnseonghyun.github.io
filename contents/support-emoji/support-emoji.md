...
author: ash84
pub_date: '2020-01-15'
description: 사실 난 예전에는 블로그 글에 emoji를 잘 쓰지 않았다. 여러가지 이유가 있겠지만 딱딱하게 정보만 전달하자는 의미도 있었고,
  지금 다니는 회사에 오기 전까지는 사실 emoji 라는 것을 잘 사용해 보지 않았다. 작년에 발표를 하면서 동료분들이 emoji 를 사용하는 것을
  보면서 사용하게 되었고, 블로그 글에도 적용해보자라는 생각을 하게 되었다. 그런데 두둥!! 🤯 나의 블로그 글에 emoji 가 달리지가 않는 것이다.
  **좀 더 정확히 말하자면 emoji 를 넣어도 표현이 되지 않고, emoji
featured_image: ''
tags:
- emoji
- utf8mb4
